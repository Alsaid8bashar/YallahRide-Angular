...
!function (t, e) {
  ...
  var r = {
    ...
    FADE: "fade",
    VERTICAL: "vertical"
  }, o = "transitionend", c = "bsStepper", a = function (t, e, n, s) {
    var o = t[c];
    ...
    return s._setLinkListeners = function () {
      ...
      this._steps.forEach(function (e) {
        ...
        t.options.linear ? (t._clickStepLinearListener = (t.options, function (t) {
          ...
          t.preventDefault();
          var e = n(t.target, s.selectors.steps), i = n(e, s.selectors.stepper), r = i[c], o = r._steps.indexOf(e);
          a(i, o, s, function () {
            r._currentIndex = o
          })
      ...
      var t = this, e = this._currentIndex - 1 >= 0 ? this._currentIndex - 1 : 0;
      a(this._element, e, this.options, function () {
        t._currentIndex = e
      })
    }, s.to = function (t) {
      var e = this, n = t - 1, s = n >= 0 && n < this._steps.length ? n : 0;
